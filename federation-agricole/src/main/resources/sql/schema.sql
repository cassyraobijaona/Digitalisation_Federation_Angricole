...
CREATE TABLE compte_membre (
                               ...
                               type       VARCHAR(20) NOT NULL CHECK (type IN ('mobile_money', 'bancaire')),
                               titulaire  VARCHAR(150) NOT NULL,
                               service    VARCHAR(30),  -- Orange Money, Mvola, Airtel Money
                               banque     VARCHAR(50),  -- BRED, MCB, BMOI...
...
CREATE TABLE autorisation_ouverture (
                                        ...
                                        statut           VARCHAR(20) NOT NULL CHECK (statut IN ('accordee', 'refusee', 'en_attente'))
);
...
CREATE TABLE encaissement (
                              ...
                              compte_membre_id  INT           REFERENCES compte_membre(id),
                              montant           DECIMAL(15,2) NOT NULL,
